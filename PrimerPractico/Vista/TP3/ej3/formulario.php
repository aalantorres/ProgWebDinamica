...
<body class="bg-light">
  ...
  <div class="container mt-4">
    <form class="border rounded bg-white" action="../../../Control/TP3/ej3.php" method="post" enctype="multipart/form-data">

      <div class="bg-light p-2 border-bottom">
        <h2 class="m-0 text-primary"> <i class="bi bi-pencil-square"></i>
          Cinem@s</h2>
      </div>
